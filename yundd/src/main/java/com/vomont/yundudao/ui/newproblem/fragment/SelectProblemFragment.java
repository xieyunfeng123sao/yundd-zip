...
public class SelectProblemFragment extends Fragment implements INewProblemView
{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState)
    {
        ...
        problem_tome_list.setOnRefreshListener(new OnRefreshListener2<ListView>()
        {
            ...
            {
                page = 1;
                presenter.getProblemList(shareUtil.getShare().getUserid() + "", 0, 0, 0);
            }
            ...
            {
                page++;
                presenter.getProblemList(shareUtil.getShare().getUserid() + "", mlist.get(mlist.size() - 1).getProblemid(), 0, 0);
            }
        });
        ...
        switch (requestCode)
        {
            case 20:
                if (data != null)
                {
                    ...
                    // action_result = data.getIntExtra("result", 0);
