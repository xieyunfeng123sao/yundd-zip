...
@SuppressLint("InflateParams") public class OneAdapter extends BaseAdapter {
	...
	public OneAdapter(List<FactoryInfo> mlist, Context context) {
		this.mlist = mlist;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		holder.text.setText(mlist.get(position).getFactoryname());
