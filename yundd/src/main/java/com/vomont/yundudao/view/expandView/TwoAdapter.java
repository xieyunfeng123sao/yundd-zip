...
@SuppressLint("InflateParams") public class TwoAdapter extends BaseAdapter {
	...
	public TwoAdapter(List<SubFactory> mlist, Context context) {
		this.mlist = mlist;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		holder.text.setText(mlist.get(position).getSubfactoryname());
