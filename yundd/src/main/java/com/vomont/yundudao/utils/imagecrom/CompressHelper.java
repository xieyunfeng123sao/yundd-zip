package com.vomont.yundudao.utils.imagecrom;
...
public class CompressHelper
{
    ...
    public static CompressHelper getDefault(Context context)
    {
        if (compressHelper == null)
            compressHelper = new CompressHelper(context);
    ...
    {
        return ImageUtil.compressImage(context, Uri.fromFile(file), maxWidth, maxHeight, compressFormat, bitmapConfig, quality, destinationDirectoryPath, fileNamePrefix, fileName);
    }
