...
public class CommonUtil {
    ...
    static public int memToStream(byte[] bytes, int offset, int n)
	{
    	bytes[offset] = (byte) (n & 0xff);
    	bytes[offset + 1] = (byte)((n & 0xff00) >> 8);
    	bytes[offset + 2] = (byte) ((n & 0xff0000) >> 16);
    	bytes[offset + 3] = (byte)((n & 0xff000000) >> 24 );
